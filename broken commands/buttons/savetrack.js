...
export default async ({ inter, queue }) => {
    ...
    inter.member.send({
        ...
        inter.editReply({ content: `I have sent you the title of the music by private messages `, ephemeral: true });
    }).catch(error => {
        inter.editReply({ content: `Unable to send you a private message... try again ? `, ephemeral: true });
    });
}